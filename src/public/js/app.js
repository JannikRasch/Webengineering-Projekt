...
//Popup schließen, wenn man außerhaln des Popups klickt
...
//Popup schließen, wenn man den 'X' Knopft drückt
...
//Funktion die das Popup öffnet
function openPopup(popup){
  if(popup == null) return
  popup.classList.add('active')
  overlay.classList.add('active')
}
//Funktion die das Popup schließt
...
//EventListener für den submit Knopf
button.addEventListener('click', function(name){
fetch('https://api.openweathermap.org/data/2.5/weather?q='+input.value+'&appid=1fe841666d27105582f1c814996249f4'+'&lang=de'+'&units=metric') //Api des aktuellen Wetters mit eingegebenem Wert aufrufen
.then(response => response.json())
.then(data => {
  //Zugriff auf die Daten an den enstprechenden Stellen in der json
